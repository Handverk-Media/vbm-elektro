  ...
  return (
    <div className="lp3-page">
      ...
      <LpHero
        ...
        h1="Hva koster det å få montert elbillader?"
      ...
      <LpSection id="prisinformasjon" label="Hva du får" heading="Dette inngår i arbeidet — og dette påvirker prisen" tint>
        <div className="lp3-cols">
          <div>
            <p className="lp3-col-title">Inngår i arbeidet</p>
          ...
          <div>
            <p className="lp3-col-title">Påvirker prisen</p>
            <ul className="lp3-col-list">
      ...
      <section id="kontakt" className="lp3-closing">
        ...
        <div className="lp3-wrap lp3-wrap-narrow" style={{ position: 'relative' }}>
          <h2 className="lp3-h2" style={{ marginBottom: 32 }}>Send bilde og få pris — eller ring oss direkte</h2>
