    ...
    <div className="lp3-page">
      ...
      <section className="lp3-hero">
        <div className="lp3-wrap">
          ...
          <h1>Zaptec Go ferdig montert hjemme</h1>
          <p className="lp3-hero-lede">Send bilde av sikringsskapet. Vi vurderer anlegget og gir skriftlig pris før montering.</p>
          <div className="lp3-cta-row">
            <a href="#skjema" className="lp3-btn lp3-btn-primary" onClick={() => trackLpPrimaryCta(PAGE)}>Få pris på Zaptec Go</a>
      ...
      <section id="prisinformasjon" className="lp3-section lp3-section-tint">
        <div className="lp3-wrap">
          ...
          <h2 className="lp3-h2">Dette gjør vi — og dette avgjør prisen</h2>
      ...
      <section id="kontakt" className="lp3-section" style={{ textAlign: 'center' }}>
        <div className="lp3-wrap lp3-wrap-narrow">
          <h2 className="lp3-h2">Få pris på Zaptec Go — eller ring oss direkte</h2>
