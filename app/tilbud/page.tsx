  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    await fetch("/api/befaring-lead", {
      ...
      body: JSON.stringify({
        ...
        source: "VBM Elektro – Tilbudsskjema",
      }),
    }).catch(() => {})
    setLaster(false)
    setSendt(true)
          ...
          <div className="book-box">
            <div className="book-header">
              <div className="book-eyebrow">
                ...
                <span>Fastpris · Ingen forpliktelser</span>
              </div>
              <h1>Få tilbud</h1>
              <p>{sendt ? "Vi tar kontakt innen 1 time" : "Beskriv jobben — vi svarer raskt med pris"}</p>
            </div>

            {sendt ? (
              <div className="page-form-card" style={{ textAlign: "center", padding: "48px 32px" }}>
                <div style={{ fontSize: 48, marginBottom: 16 }}>✓</div>
                <h2 style={{ marginBottom: 12 }}>Mottatt!</h2>
                <p style={{ color: "var(--text-soft)", marginBottom: 24 }}>
                  Vi har fått din henvendelse og ringer deg innen 1 time i normal arbeidstid.
                </p>
                <a href="/" className="btn btn-red">Tilbake til forsiden</a>
              </div>
            ) : (
              <div className="page-form-card">
                <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                  ...
                  <div className="form-field">
                    ...
                    <textarea name="melding" rows={4} placeholder="Fortell gjerne hva som skal gjøres, størrelse på jobb, om du har bilder osv." style={{ resize: "vertical" }} />
                  </div>
                  ...
                  <p className="form-note">Vi svarer innen 1 time i arbeidstid · Gratis og uforpliktende</p>
                </form>
              </div>
            )}
