...
export const IcMail = ({ size = 22 }: P) => (
  <svg width={size} height={size} viewBox="0 0 24 24" {...base}><rect x="3" y="5" width="18" height="14" rx="1.5" /><path d="m4 6.5 8 6 8-6" /></svg>
)
export const IcPhoneOutline = ({ size = 22 }: P) => (
  <svg width={size} height={size} viewBox="0 0 24 24" {...base}><path d="M5 4h3.2l1.3 4-2 1.5a11 11 0 005 5l1.5-2 4 1.3V17a2 2 0 01-2 2A14 14 0 015 6a2 2 0 010-2z" /></svg>
)
export const IcChat = ({ size = 22 }: P) => (
  <svg width={size} height={size} viewBox="0 0 24 24" {...base}><path d="M4 5.5h16v11H9l-4 3.5v-3.5H4z" /><circle cx="9" cy="11" r="0.9" fill="currentColor" stroke="none" /><circle cx="12" cy="11" r="0.9" fill="currentColor" stroke="none" /><circle cx="15" cy="11" r="0.9" fill="currentColor" stroke="none" /></svg>
)
...
export const IcCheckCircle = ({ size = 22 }: P) => (
  <svg width={size} height={size} viewBox="0 0 24 24" {...base}><circle cx="12" cy="12" r="9" /><path d="m8.4 12.2 2.4 2.4 4.8-5.2" /></svg>
)
export const IcUploadCloud = ({ size = 22 }: P) => (
  <svg width={size} height={size} viewBox="0 0 24 24" {...base}><path d="M7 17a4 4 0 01-.6-7.95A5.5 5.5 0 0117 7.6 4.2 4.2 0 0117.5 16" /><path d="M12 20v-7m0 0-2.6 2.6M12 13l2.6 2.6" /></svg>
)
export const IcLock = ({ size = 22 }: P) => (
  <svg width={size} height={size} viewBox="0 0 24 24" {...base}><rect x="5.5" y="10.5" width="13" height="9.5" rx="1.5" /><path d="M8.5 10.5V8a3.5 3.5 0 017 0v2.5" /></svg>
)
export const IcSend = ({ size = 22 }: P) => (
  <svg width={size} height={size} viewBox="0 0 24 24" {...base}><path d="m21 3-9.5 18-2.2-7.3L2 11.5 21 3z" /><path d="M21 3 9.3 13.7" /></svg>
)
export const IcUser = ({ size = 22 }: P) => (
  <svg width={size} height={size} viewBox="0 0 24 24" {...base}><circle cx="12" cy="8.5" r="3.5" /><path d="M5.5 19.5c1-3.4 3.5-5 6.5-5s5.5 1.6 6.5 5" /></svg>
)
export const IcDistance = ({ size = 22 }: P) => (
  <svg width={size} height={size} viewBox="0 0 24 24" {...base}><path d="M4 18V6m16 12V6M7 12h10m-10 0 2.5-2.5M7 12l2.5 2.5m7.5-2.5L14.5 9.5m2.5 2.5-2.5 2.5" /></svg>
)
export const IcCable = ({ size = 22 }: P) => (
  <svg width={size} height={size} viewBox="0 0 24 24" {...base}><path d="M4 16c4-6 6 6 10 0 2-3 4-3 6-1" /><circle cx="4" cy="16" r="1.6" /><circle cx="20" cy="14" r="1.6" /></svg>
)
export const IcPanelLines = ({ size = 22 }: P) => (
  <svg width={size} height={size} viewBox="0 0 24 24" {...base}><rect x="5" y="4" width="14" height="16" rx="1.5" /><path d="M9 8h6M9 12h6M9 16h3" /></svg>
)
export const IcBalance = ({ size = 22 }: P) => (
  <svg width={size} height={size} viewBox="0 0 24 24" {...base}><path d="M5 8h14M5 16h14" /><circle cx="9" cy="8" r="2" /><circle cx="15" cy="16" r="2" /></svg>
)
export const IcWrench2 = ({ size = 22 }: P) => (
  <svg width={size} height={size} viewBox="0 0 24 24" {...base}><path d="M14.5 6.5a4 4 0 0 0-5.6 4.6L4 16v4h4l4.9-4.9a4 4 0 0 0 4.6-5.6L14.7 12l-2.7-2.7 2.5-2.8z" /></svg>
)
export const IcClipboardCheck = ({ size = 130 }: P) => (
  <svg width={size} height={size} viewBox="0 0 24 24" {...base}><path d="M9 4.5h6M9 4.5a1.5 1.5 0 0 0-1.5 1.5v0H6a1 1 0 0 0-1 1v13a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V7a1 1 0 0 0-1-1h-1.5v0A1.5 1.5 0 0 0 15 4.5M9 4.5v3h6v-3" /><path d="m9 14 2 2 4-4.5" /></svg>
)
export const IcCalculator = ({ size = 130 }: P) => (
  <svg width={size} height={size} viewBox="0 0 24 24" {...base}><rect x="6" y="3.5" width="12" height="17" rx="1.5" /><path d="M9 7h6M9.5 11.5h0M12 11.5h0M14.5 11.5h0M9.5 14.5h0M12 14.5h0M14.5 14.5h0M9.5 17.5h5" /></svg>
)
export const IcPencil = ({ size = 22 }: P) => (
  <svg width={size} height={size} viewBox="0 0 24 24" {...base}><path d="m14.5 5.5 4 4L8 20H4v-4L14.5 5.5z" /><path d="m12.5 7.5 4 4" /></svg>
)
